...
setup(
    name='pydivert',
    version=__version__,
    description='Python binding to windivert driver. Bundled with WinDivert 1.4.3',
    long_description=long_description,
    author='Fabio Falcinelli',
    author_email='fabio.falcinelli@gmail.com',
    url='https://github.com/anggaranothing/pydivert',
    download_url='https://github.com/anggaranothing/pydivert/releases/{}'.format(__version__),
